...
const rechazada  = "<h1 class='text-center mb-3 p-3 fw-bold'>Lo sentimos " + nombre + "!</h1> <br>  <h3 class='mb-4 position-absolute start-50 translate-middle alert alert-danger fst-italic'>No puedes ver esta página</h3>";
